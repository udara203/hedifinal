document.addEventListener("DOMContentLoaded", function () {
    var productsDropdown = document.querySelector('.product-dropdown');

    // Hide the product dropdown on page load
...
function toggleProductList() {
    ...
    // Toggle the display of the product dropdown
    productDropdown.style.display = (productDropdown.style.display === 'block') ? 'none' : 'block';
}

// Hide the product dropdown when clicking outside of it
document.addEventListener('click', function (event) {
    var productDropdown = document.querySelector('.product-dropdown');
    var productsButton = document.querySelector('.products-button');

    if (!event.target.matches('.products-button') && !event.target.matches('.product-dropdown')) {
